...
function Et() {
  ...
  class n {
    ...
    runTask(s, i, o) {
      ...
      let E = s,
        { type: H, data: { isPeriodic: ee = !1, isRefreshable: A = !1 } = {} } = s;
    ...
    scheduleTask(s) {
      ...
      try {
        ...
        throw (s._transitionTo(q, k, W), this._zoneDelegate.handleError(this, o), o);
      }
      return (
    ...
    cancelTask(s) {
      ...
      if (!(s.state !== d && s.state !== j)) {
        ...
        try {
          ...
          throw (s._transitionTo(q, $), this._zoneDelegate.handleError(this, i), i);
        }
        return this._updateTaskCount(s, -1), s._transitionTo(W, $), (s.runCount = -1), s;
      }
    }
  ...
  class f {
    ...
    fork(s, i) {
      return this._forkZS ? this._forkZS.onFork(this._forkDlgt, this.zone, s, i) : new n(s, i);
    }
    intercept(s, i, o) {
    ...
    invoke(s, i, o, E, H) {
      return this._invokeZS
        ? this._invokeZS.onInvoke(this._invokeDlgt, this._invokeCurrZone, s, i, o, E, H)
        : i.apply(o, E);
    }
    handleError(s, i) {
...
var ot = typeof WorkerGlobalScope < 'u' && self instanceof WorkerGlobalScope,
  Oe = !('nw' in X) && typeof X.process < 'u' && X.process.toString() === '[object process]',
  ...
  Ke = function (e) {
    ...
    if (Ve && c === ye && e.type === 'error') {
      let f = e;
      (a = n && n.call(this, f.message, f.filename, f.lineno, f.colno, f.error)),
...
function Je(e, t, c) {
  let n = be(e, t);
  if ((!n && c && be(c, t) && (n = { enumerable: !0, configurable: !0 }), !n || !n.configurable))
    return;
  ...
  y || (y = Ne[g] = Z('ON_PROPERTY' + g)),
    ...
    (n.get = function () {
      ...
      if (f) {
        let w = f.call(this);
        if (w) return n.set.call(this, w), typeof N[kt] == 'function' && N.removeAttribute(t), w;
      }
      return null;
    }),
    Ze(e, t, n),
...
function St(e, t, c, n) {
  ...
  function K(k, d) {
    ...
    let s = function (r) {
        if (!O.isExisting) return P.call(O.target, O.eventName, O.capture ? Y : V, O.options);
      },
      i = function (r) {
        if (!r.isRemoved) {
        ...
        if (r.allRemoved) return b.call(r.target, r.eventName, r.capture ? Y : V, r.options);
      },
      o = function (r) {
      ...
      return function () {
        ...
        if (Q) {
          for (let ie = 0; ie < Q.length; ie++)
            if (D === Q[ie]) return de ? r.call(I, D, U, se) : r.apply(this, arguments);
        }
        ...
        if (ge) {
          ...
          r.call(ge, 'abort', ie, { once: !0 }),
            (re.removeAbortListener = () => ge.removeEventListener('abort', ie));
        }
        if (
          ((O.target = null),
          ke && (ke.taskData = null),
          ...
          for (let U = 0; U < D.length; U++) {
            ...
            if (_e(z, p)) {
              if (
                (D.splice(U, 1),
                (z.isRemoved = !0),
                D.length === 0 && ((z.allRemoved = !0), (r[I] = null), !R && typeof u == 'string'))
              ) {
...
function me(e, t, c, n) {
  ...
  function g(N) {
    ...
    return tt(w) ? (_.handleId = w) : ((_.handle = w), (_.isRefreshable = et(w.refresh))), N;
  }
  function y(N) {
        ...
        if (et(w[0])) {
          ...
          w[0] = function () {
            try {
              ...
              let { handle: j, handleId: $, isPeriodic: q, isRefreshable: B } = M;
              !q && !B && ($ ? delete T[$] : j && (j[Re] = null));
            }
          };
          let V = Ue(t, w[0], M, g, y);
          if (!V) return V;
          let { handleId: Y, handle: K, isRefreshable: W, isPeriodic: k } = V.data;
          if (Y) T[Y] = V;
    ...
    (f = ue(
      ...
      (N) =>
        function (_, w) {
          let M = w[0],
            x;
          tt(M) ? ((x = T[M]), delete T[M]) : ((x = M?.[Re]), x ? (M[Re] = null) : (x = M)),
...
function Dt(e, t) {
  ...
  let g = e.EventTarget;
  if (!(!g || !g.prototype)) return t.patchEventTarget(e, t, [g && g.prototype]), !0;
}
function Mt(e, t) {
    ...
    e.__load_patch('XHR', (t, c) => {
      ...
      function N(_) {
        ...
        function k(P) {
              ...
              if (!b.aborted && S[T] && P.state === W) {
                ...
                if (S.status !== 0 && s && s.length > 0) {
                  ...
                  (P.invoke = function () {
                    ...
                    for (let E = 0; E < o.length; E++) o[E] === P && o.splice(E, 1);
          ...
          return V.call(S, K, F), S[n] || (S[n] = P), G.apply(S, b.args), (S[T] = !0), P;
        }
        function d() {}
        function j(P) {
          let b = P.data;
  ...
  e.__load_patch('ZoneAwarePromise', (t, c, n) => {
    ...
    function L(h, l, r) {
      ...
      if (h[k] === m) {
        ...
        if (l !== O && r instanceof A && r.hasOwnProperty(k) && r.hasOwnProperty(d) && r[k] !== m)
          i(r), L(h, r[k], r[d]);
...
` + r.stack
    ...
    function o(h, l, r, u, v) {
      i(h);
      let R = h[k],
        p = R ? (typeof u == 'function' ? u : K) : typeof v == 'function' ? v : W;
      l.scheduleMicroTask(
        B,
        () => {
          try {
    ...
    class A {
        ...
        return new A((p, C) => {
          for (let I = 0; I < r.length; I++)
            r[I].then(
              ...
              (D) => {
                R.push(D), u--, u === 0 && ((v = !0), C(new ee(R, 'All promises were rejected')));
              },
            );
        });
      }
      ...
      static allSettled(l) {
        return (this && this.prototype instanceof A ? this : A).allWithCallback(l, {
      ...
      constructor(l) {
        let r = this;
        if (!(r instanceof A)) throw new Error('Must be an instanceof Promise.');
        (r[k] = m), (r[d] = []);
        try {
          let u = S();
          l && l(u(b(r, G)), u(b(r, O)));
...
function Zt(e) {
  e.__load_patch('toString', (t) => {
    let c = Function.prototype.toString,
      ...
      T = function () {
        if (typeof this == 'function') {
          let _ = this[n];
          if (_) return typeof _ == 'function' ? c.call(_) : Object.prototype.toString.call(_);
          if (this === Promise) {
            let w = t[a];
    ...
    Object.prototype.toString = function () {
      return typeof Promise == 'function' && this instanceof Promise ? y : g.call(this);
    };
  });
}
